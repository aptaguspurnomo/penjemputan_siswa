...
<h2 class="text-2xl font-bold mb-4"><i class="fas fa-car"></i> Manajemen Status Penjemputan</h2>
<table class="w-full border-collapse border">
    ...
    <tbody>
        <?php
        $query = "SELECT s.id, s.nama_siswa, k.nama_kelas, sp.status, sp.nama_penjemput, sp.waktu_penjemputan 
                  FROM siswa s 
                    ...
                    <td class='border p-2'>
                        <form method='POST'>
                            ...
                            <select name='status' class='p-2 border rounded'>
                                ...
                                <option value='proses_belajar'>Proses Belajar</option>
